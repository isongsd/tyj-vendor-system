                ...
                <div className="p-4">
                    ...
                    {(isLoading && !bookings.length) ? (
                        ...
                        <>
                            ...
                            <CalendarView currentDate={currentDate} setCurrentDate={setCurrentDate} bookings={bookings} onDayClick={handleDayClick} />
...
const CalendarView = ({ currentDate, setCurrentDate, bookings, onDayClick }) => {
        ...
        <div className="mt-4">
            ...
            <div className="border-t border-gray-200">
                {days.map(day => {
                    ...
                    return (
                        <div key={dateStr} onClick={() => onDayClick(dateStr)} className="flex items-start gap-4 p-3 border-b border-gray-200 cursor-pointer hover:bg-blue-50">
                            <div className={`text-center w-12 flex-shrink-0 ${isWeekend ? 'text-red-500' : 'text-gray-800'}`}>
                            ...
                            <div className="flex-grow grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2">
                                {dayBookings.length > 0 ? dayBookings.map(b => (
                                    <div key={b.id} className="p-2 rounded-md bg-green-100 text-green-800 font-semibold text-center">
                                        {b.marketName}
                                    </div>
                                )) : (
                                    <div className="text-gray-400 text-sm italic col-span-full">本日無登記</div>
                                )}
                            </div>
                        </div>
                    )
